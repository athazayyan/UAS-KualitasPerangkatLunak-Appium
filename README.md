...
## 🏗️ Arsitektur Framework (Page Object Model)
...
* **Alur:** Input username `standard_user` ➡️ Input password `secret_sauce` ➡️ Klik tombol Login.
...
* **Alur:** Reset sesi aplikasi ➡️ Input username `standard_user` ➡️ Input password salah `password_salah` ➡️ Klik tombol Login.
...
## 🛠️ Prasyarat Sistem & Dependensi (Environment)
